        ...
        if uploaded_files and processed_files:
            ...
            if 'calibration_results' in st.session_state:
                ...
                if results['type'] == 'peak_area':
                    ...
                    fig_cal.update_layout(
                        title=f'PLS検量線 (成分数: {results["n_components"]})',
                        xaxis_title='実測値',
                        yaxis_title='予測値'
                    )
