...
class RamanEyeApp:
    ...
    def _render_sidebar(self):
        ...
        # 2. パラメーター
        st.sidebar.markdown("---")
        st.sidebar.subheader("⚙️ パラメーター")
        self._render_parameters(analysis_mode)
    ...
    def _render_parameters(self, analysis_mode):
        """解析パラメーターの表示"""
        parameters = {
            "スペクトル解析": """
            **基本パラメーター:**
        ...
        parameter = parameters.get(analysis_mode, "パラメーター情報なし")
